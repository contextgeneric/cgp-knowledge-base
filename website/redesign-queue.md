...
standing completeness obligation once started: a construct with no page is a hole a reader falls into.
Spec and porting procedure in [writing-guides/reference.md](writing-guides/reference.md). Two
dependencies are worth noting — the *index* page is hand-written rather than autogenerated, and the
reference's *When to reach for it* sections are where the internal [guides](../cgp/guides/README.md)
reach the public site, since they have no public home of their own.
