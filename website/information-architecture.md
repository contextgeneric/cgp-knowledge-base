...
**Reference** (new category, plus an index) — present, and **nearly complete**
- One page per named construct, grouped as `macros/`, `attributes/`, `derives/`, `components/`,
  `providers/`, `traits/`, and `types/`. All are scaffolded; 160 are written — `macros/` (20),
  `attributes/` (8), `derives/` (8), `traits/` (57), `providers/` (50), and `components/` (17) are
