...
- An *error catalog* page — **new**. The compile errors CGP produces after codegen, organized by the
  internal catalog's hidden-versus-surfaced axis, so a reader who hits a wiring failure has somewhere on
  the site to look it up. One page rather than seventeen, drawn from
