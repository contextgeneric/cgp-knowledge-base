...
effects, row polymorphism, dependency injection, dynamic dispatch, reflection, and capabilities. The
...
and the current state is recorded in [site-structure.md](site-structure.md). Fourteen Concepts pages
