...
The repository's tests also carry a simplified form, which the announcement post and the
[modular serialization example](../../../examples/modular-serialization.md) use. It defines its own
