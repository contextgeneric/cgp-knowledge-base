...
The public reference is organized one page per named construct, so this document feeds **7 pages** rather than one: [`has_builder`](https://contextgeneric.dev/docs/reference/traits/has_builder), [`into_builder`](https://contextgeneric.dev/docs/reference/traits/into_builder), [`update_field`](https://contextgeneric.dev/docs/reference/traits/update_field), [`build_field`](https://contextgeneric.dev/docs/reference/traits/build_field), [`take_field`](https://contextgeneric.dev/docs/reference/traits/take_field), [`partial_data`](https://contextgeneric.dev/docs/reference/traits/partial_data), [`finalize_build`](https://contextgeneric.dev/docs/reference/traits/finalize_build). A change here is propagated to each of them, per the [synchronization rule](../../../AGENTS.md#the-synchronization-rule); the mapping and the granularity rule behind it are recorded in [website/site-structure.md](../../../website/site-structure.md).
