...
The public reference is organized one page per named construct, so this document feeds **8 pages** rather than one: [`has_optional_builder`](https://contextgeneric.dev/docs/reference/traits/has_optional_builder), [`to_optional`](https://contextgeneric.dev/docs/reference/traits/to_optional), [`set_optional`](https://contextgeneric.dev/docs/reference/traits/set_optional), [`finalize_optional`](https://contextgeneric.dev/docs/reference/traits/finalize_optional), [`can_finalize_with_default`](https://contextgeneric.dev/docs/reference/traits/can_finalize_with_default), [`can_build_with_default`](https://contextgeneric.dev/docs/reference/traits/can_build_with_default), [`transform_map_default`](https://contextgeneric.dev/docs/reference/traits/transform_map_default), [`transform_optional`](https://contextgeneric.dev/docs/reference/traits/transform_optional). A change here is propagated to each of them, per the [synchronization rule](../../../AGENTS.md#the-synchronization-rule); the mapping and the granularity rule behind it are recorded in [website/site-structure.md](../../../website/site-structure.md).
