...
- The `Cons`/`Nil` spine it recurses over is defined in [crates/core/cgp-base-types/src/types/](https://github.com/contextgeneric/cgp/tree/main/crates/core/cgp-base-types/src/types/) (`cons.rs` and `nil.rs`).
